...
public abstract class MessagesBicitools {
    ...
    public static String getMessage(String name, String valor){
        ResourceBundle rb = ResourceBundle.getBundle("prop.general");
        String dato=(String) rb.getObject(name);
        dato= dato.replace("***", valor);
        return dato;
    }
    ...
    public static String getEndPoint(String name) {
        ResourceBundle rb = ResourceBundle.getBundle("prop.enpoint");
        return (String) rb.getObject(name);
