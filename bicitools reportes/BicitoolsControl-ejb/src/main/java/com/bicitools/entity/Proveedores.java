...
public class Proveedores implements Serializable {
    ...
    private Collection<Partes> partesCollection;
    ...
    @XmlTransient
    public Collection<Partes> getPartesCollection() {
        return partesCollection;
    }

    public void setPartesCollection(Collection<Partes> partesCollection) {
        this.partesCollection = partesCollection;
    }
    ...
    public String toString() {
        return "com.bicitools.entity.Proveedores[ idProveedor=" + idProveedor + " ]";
    }
