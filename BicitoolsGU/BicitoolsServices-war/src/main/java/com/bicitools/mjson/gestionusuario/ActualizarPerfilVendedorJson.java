 ...
 * @author TaidyJohana
 */
public class ActualizarPerfilVendedorJson {
    Integer id_usuario;
     String nombre_establecimiento,  direccion_establecimiento,  telefono_establecimiento, 
              celular_establecimiento,  correo_establecimiento,  nit_establecimiento,  foto_establecimiento;

    public ActualizarPerfilVendedorJson() {
    }

    @Override
    public String toString() {
        return "ActualizarPerfilVendedorJson{" + "id_usuario=" + id_usuario + ", nombre_establecimiento=" + nombre_establecimiento + ", direccion_establecimiento=" + direccion_establecimiento + ", telefono_establecimiento=" + telefono_establecimiento + ", celular_establecimiento=" + celular_establecimiento + ", correo_establecimiento=" + correo_establecimiento + ", nit_establecimiento=" + nit_establecimiento + ", foto_establecimiento=" + foto_establecimiento + '}';
    }
