 ...
 * @author TaidyJohana
 */
public class RegistrarUsuarioFacebookJson {
    ...
    telefonoFijo,  telefonoMovil,  facebookUser, facebookToken, twitterUser, usuario,  contrasenia;

    public RegistrarUsuarioFacebookJson() {
    }
