 ...
 * @author TaidyJohana
 */
public class RegistrarUsuarioTwitterJson {
    ...
    telefonoFijo,  telefonoMovil,  facebookUser,  twitterUser,twitterToken, usuario,  contrasenia;
    ...
    public RegistrarUsuarioTwitterJson() {
    }
    ...
    public String toString() {
        return "RegistrarUsuarioTwitterJson{" + "numeroIdentificacion=" + numeroIdentificacion + ", tipoIdentificacion=" + tipoIdentificacion + ", tipoPerfil=" + tipoPerfil + ", genero=" + genero + ", nombres=" + nombres + ", apellidos=" + apellidos + ", foto=" + foto + ", correo=" + correo + ", direccionCasa=" + direccionCasa + ", direccionTrabajo=" + direccionTrabajo + ", fechaNacimiento=" + fechaNacimiento + ", telefonoFijo=" + telefonoFijo + ", telefonoMovil=" + telefonoMovil + ", facebookUser=" + facebookUser + ", twitterUser=" + twitterUser + ", twitterToken=" + twitterToken + ", usuario=" + usuario + ", contrasenia=" + contrasenia + '}';
    }
